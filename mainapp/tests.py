...
class TestNewsPage(TestCase):
    ...
    def setUp(self):
        ...
        self.client_with_auth.force_login(self.user_admin, backend="authapp.backends.CaseInsensitiveModelBackend")
...
class TestCoursesWithMock(TestCase):
    ...
    def test_page_open_detail(self):
        ...
        with open(f"mainapp/fixtures/005_feedback_list_1.bin", "rb") as inpf, mock.patch(
